...
import { getDefaultGroupName, getLeadingEmoji, runAsyncFunction, uuid } from '@/utils'
      ...
      if (state.shortcuts) {
        state.shortcuts.shortcuts.push(
          ...
          },
          {
            ...
            shortcut: [window.isMac ? 'Command' : 'Ctrl', 'R'],
            editable: true,
            enabled: true,
            system: false
          }
