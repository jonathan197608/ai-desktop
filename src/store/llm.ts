...
export const INITIAL_PROVIDERS: Provider[] = [
  ...
  },
  {
    ...
    type: 'openai',
    apiKey: '',
    apiHost: 'https://wishub-x1.ctyun.cn/compatible-mode',
...
const initialState: LlmState = {
  defaultModel: SYSTEM_MODELS.xirang[0],
  topicNamingModel: SYSTEM_MODELS.xirang[0],
  translateModel: SYSTEM_MODELS.xirang[0],
