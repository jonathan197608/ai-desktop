...
import ImageSize1_1 from '@/assets/images/paintings/image-size-1-1.svg'
import ImageSize1_2 from '@/assets/images/paintings/image-size-1-2.svg'
import ImageSize3_2 from '@/assets/images/paintings/image-size-3-2.svg'
import ImageSize3_4 from '@/assets/images/paintings/image-size-3-4.svg'
import ImageSize9_16 from '@/assets/images/paintings/image-size-9-16.svg'
import ImageSize16_9 from '@/assets/images/paintings/image-size-16-9.svg'
import { Navbar, NavbarCenter, NavbarRight } from '@/components/app/Navbar'
...
import { DEFAULT_PAINTING } from '@/store/paintings'
import { setGenerating } from '@/store/runtime'
import type { FileType, Painting } from '@/types'
...
const PaintingsPage: FC = () => {
  ...
  const onDeletePainting = (paintingToDelete: Painting) => {
    ...
    removePainting(paintingToDelete).then()
