                ...
                <>
                  ...
                  <Tooltip title={t('common.copy')} mouseEnterDelay={0.5}>
                    <ActionButton
                      ...
                      onClick={(e) => {
                        e.stopPropagation()
                        copyContent(JSON.stringify(result, null, 2), id).then()
                      }}
        ...
        {expandedResponse && (
          <ExpandedResponseContainer style={{ fontFamily, fontSize }}>
            <ActionButton
              ...
              onClick={() => {
                if (expandedResponse) {
                  navigator.clipboard.writeText(expandedResponse.content).then()
                  antdMessage.success({ content: t('message.copied'), key: 'copy-expanded' }).then()
                }
              }}
              aria-label={t('common.copy')}>
